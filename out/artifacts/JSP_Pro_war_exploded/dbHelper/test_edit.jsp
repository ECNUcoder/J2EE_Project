...
<% List<Test_category> test_categories = DbHelper.getTitleName();
  Question question = DbHelper.getSingle(Integer.parseInt(request.getParameter("id")));
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <div class="container">
    <div class="col-md-6 col-md-push-3">
      <form action="../db" method="post" role ="form">
        <input type="hidden" name="id" value="<%=question.title_id%>">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" id = "option1" name = "option1" class="form-control" value="<%=question.option[0]%>">
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" id = "option2" name = "option2" class="form-control" value="<%=question.option[1]%>" >
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" id = "option3" name = "option3" class="form-control" value="<%=question.option[2]%>" >
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" id = "option4" name = "option4" class="form-control" value="<%=question.option[3]%>" >
          </div>
        </div>
